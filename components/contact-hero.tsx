    ...
    >
      <div className="absolute inset-0 z-0">
        <motion.div style={{ scale, opacity }}>
          <Image
            ...
            alt="Contactez Hauts Numériques et Médias"
            fill
            className="object-cover object-center brightness-[0.2]" // Assombri pour plus de contraste
            priority
          />
        </motion.div>
      ...
      <div className="container relative z-10 mx-auto px-4">
        ...
        >
          ...
          >
            <span className="text-slate-950">Discutons de votre </span>
